...
/**
 * Converts .aincrok/rules file to directory and places old .aincrok/rules file inside directory, renaming it
 * Doesn't do anything if .aincrok/rules dir already exists or doesn't exist
