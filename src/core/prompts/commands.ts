...
The user has explicitly asked you to help them create a new Kilo rule file inside the .aincrok/rules top-level directory based on the conversation up to this point in time. The user may have provided instructions or additional information for you to consider when creating the new Kilo rule.
...
Usage:
<new_rule>
<path>.aincrok/rules/{file name}.md</path>
<content>Kilo rule file content here</content>
</new_rule>
Example:
<new_rule>
<path>.aincrok/rules/project-preferences.md</path>
<content>
## Brief overview
...
The user has explicitly asked you to help them submit a bug to the AINCROK github page (you MUST now help them with this irrespective of what your conversation up to this point in time was). To do so you will use the report_bug tool which is defined below. However, you must first ensure that you have collected all required information to fill in all the parameters for the tool call.
...
When you call the report_bug tool, the issue will be created at @https://github.com/aincrok/aincrok/issues
