			...
			<TabContent>
				<div
					...
					<Trans i18nKey="mcp:description">
						<VSCodeLink
							href={buildDocLink("features/mcp/using-mcp-in-aincrok", "mcp_settings")}
				...
				{mcpEnabled && (
					<>
						...
						<div style={{ display: "none", marginBottom: 15 }}>
							...
							<div
								...
								<Trans i18nKey="mcp:enableServerCreation.description">
									<VSCodeLink
										href={buildDocLink(
											"features/mcp/using-mcp-in-aincrok#how-to-use-aincrok-to-create-an-mcp-server",
											"mcp_server_creation",
										)}
										style={{ display: "inline" }}>
						...
						<div
							...
							<VSCodeLink
								href={buildDocLink(
									"features/mcp/using-mcp-in-aincrok#editing-mcp-settings-files",
									"mcp_edit_settings",
								)}
								style={{ display: "inline" }}>
