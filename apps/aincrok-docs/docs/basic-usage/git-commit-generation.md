...
<img src="/img/git-commit-generation/git-commit-1.png" alt="Generated commit message example" width="600" />
...
<img src="/img/git-commit-generation/git-commit-2.png" alt="Commit message generation settings" width="600" />
