...
*   If the problem persists, report the issue on [GitHub](https://github.com/aincrok/kilocode/issues) or [Discord](https://kilocode.ai/discord).
...
Please report bugs or suggest features on the Kilo Code [Issues page](https://github.com/aincrok/kilocode/issues) and [Feature Requests page](https://github.com/aincrok/kilocode/discussions/categories/ideas).
