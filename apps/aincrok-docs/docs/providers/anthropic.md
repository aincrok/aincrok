...
3.  **Create a Key:** Click "Create Key". Give your key a descriptive name (e.g., "Aincrok").
4.  **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

## Supported Models

Aincrok supports the following Anthropic Claude models:
