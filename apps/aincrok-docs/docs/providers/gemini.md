...
# Using Google Gemini With Aincrok

Aincrok supports Google's Gemini family of models through the Google AI Gemini API.
...
Aincrok supports the following Gemini models:
