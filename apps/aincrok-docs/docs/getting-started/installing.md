...
If you already have VS Code installed: [Click here to install Kilo Code](vscode:extension/kilocode.AINCROK)
...
If you already have Cursor installed: [Click here to install Kilo Code](cursor:extension/kilocode.AINCROK)
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [Kilo Code page on Open VSX Registry](https://open-vsx.org/extension/kilocode/AINCROK).
...
1. **Download the VSIX file:**
   * Find official releases on the [Kilo Code GitHub Releases page](https://github.com/aincrok/kilocode/releases)
   * Download the `.vsix` file from the [latest release](https://github.com/aincrok/kilocode/releases/latest)
...
* Submit issues on [GitHub](https://github.com/aincrok/kilocode/issues)
