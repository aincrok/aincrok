...
* 检查你选择的API提供商的状态
* 尝试重启VS Code
* 如果问题仍然存在，请在[GitHub](https://github.com/aincrok/kilocode/issues)或[Discord](https://kilocode.ai/discord)上报告问题
...
请在Kilo Code的[问题页面](https://github.com/aincrok/kilocode/issues)和[功能请求页面](https://github.com/aincrok/kilocode/discussions/categories/ideas)上报告bug或建议功能。