...
<!-- 请参考主仓库中的 [DEVELOPMENT.md](https://github.com/aincrok/kilocode/blob/main/DEVELOPMENT.md) 指南，获取详细的开发环境设置说明。 -->
...
1. **Fork 并克隆仓库**：
    ...
    - **Fork 仓库**：
        - 访问 [Aincrok GitHub 仓库](https://github.com/aincrok/kilocode)
...
2. 这将打开一个新的 VSCode 窗口，并加载 Aincrok
...
- 检查 VSCode 中的输出面板（View > Output）并从下拉菜单中选择 "Aincrok"
