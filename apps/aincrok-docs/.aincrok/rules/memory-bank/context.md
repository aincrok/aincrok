...
The Aincrok documentation site is a mature, production-ready Docusaurus project that serves as the comprehensive documentation hub for the Aincrok VS Code extension. The site is hosted at https://aincrok.dev/docs and provides extensive documentation covering installation, usage, features, and extension capabilities.
...
- **Using Aincrok**: Chat interface, modes, context mentions, and basic features
...
- **Extending Aincrok**: Model providers (18+ supported), local models, MCP integration, shell integration
