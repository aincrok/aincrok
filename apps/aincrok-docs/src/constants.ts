...
export const GITHUB_REPO_URL = 'https://github.com/aincrok/docs';
export const GITHUB_ISSUES_URL = `${GITHUB_REPO_URL}/issues`;
export const GITHUB_NEW_ISSUE_URL = `${GITHUB_ISSUES_URL}/new`;

// Community links
export const DISCORD_URL = 'https://kilocode.ai/discord';
export const REDDIT_URL = 'https://www.reddit.com/r/aincrok/';
export const TWITTER_URL = 'https://x.com/Kilo_Code';
export const YOUTUBE_URL= 'https://www.youtube.com/@AINCROK';

// GitHub links
export const GITHUB_MAIN_REPO_URL = 'https://github.com/aincrok/kilocode';
...
// Download links
export const VSCODE_MARKETPLACE_URL = 'https://marketplace.visualstudio.com/items?itemName=kilocode.aincrok';
export const OPEN_VSX_URL = 'https://open-vsx.org/extension/aincrok/aincrok';
